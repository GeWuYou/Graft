...
- the complete integration authorization evidence must be recorded in the startup receipt or task closeout before the operation is executed; missing evidence is fail-closed
