...
- The controller accepted the Build-owned immutable filtering and pagination slice. Build remains the sole history authority, the required cross-boundary validation passed, and no additional bounded batch was justified. The topic is archived as historical evidence.
