...
```json
{
  ...
  "pending_batches": ["phase-4d-contract-and-web-projection"],
  "current_batch": null,
  "next_batch": "phase-4d-contract-and-web-projection",
  "closeout_status": "phase-4c-reservation-recovery-and-dynamic-placement-complete"
}
```
