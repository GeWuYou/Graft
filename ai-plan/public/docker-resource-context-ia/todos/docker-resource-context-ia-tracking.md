...
- Batch 1 and Batch 2 are complete: OpenAPI and Container now provide one normalized resource-detail projection, Context, relationship trust, and server-side advanced filters; Network and Volume consume those contracts without frontend aggregation.
...
- Next step: final diff review, browser evidence when a developer-owned runtime is available, and closeout.

## Task Checklist

- [x] Batch 1: Context contract, relationship trust, and design guideline.
- [x] Batch 2: Network and Volume Web IA implementation.
- [ ] Batch 3: validation, browser QA, and closeout.
