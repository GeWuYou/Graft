...
export type ServerStatusDependencyHistoryPoint = components['schemas']['ServerStatusDependencyHistoryPoint'];
...
export type ServerStatusDependencies = components['schemas']['ServerStatusDependencies'];
