...
export type AppLogCategory = components['schemas']['app-log-detail-response']['category'];
...
export type AppLogSavedView = components['schemas']['saved-view'];
export type AppLogSavedViewRequest = components['schemas']['saved-view-request'];
