...
export const UPDATE_OPERATION_FAILURE_CODE = {
  ...
  RUNNER_STATE_CORRUPT: 'PLATFORM_UPDATE_RUNNER_STATE_CORRUPT',
...
export const UPDATE_OPERATION_FAILURE_MESSAGE_KEY: Record<UpdateOperationFailureCode, string> = {
  ...
  [UPDATE_OPERATION_FAILURE_CODE.RUNNER_STATE_CORRUPT]: 'update.center.confirmation.failure.runnerStateCorrupt',
