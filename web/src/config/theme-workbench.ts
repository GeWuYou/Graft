...
export const GRAFT_BASE_THEME_TOKENS: ThemeModeTokenState = {
  ...
  dark: {
    ...
    '--td-bg-color-container-hover': '#1f2630',
    '--td-bg-color-secondarycontainer': '#111822',
    '--td-bg-color-component': '#212832',
    '--td-text-color-primary': '#f0f3f8',
    '--td-text-color-secondary': '#aeb8c7',
    '--td-text-color-placeholder': '#778397',
    '--td-text-color-disabled': '#5f6b7c',
    '--td-component-border': '#303946',
    '--td-component-stroke': '#27313d',
    '--td-border-level-1-color': '#27313d',
    '--td-scrollbar-color': '#3a4655',
    '--graft-shell-bg': '#0d1117',
    '--graft-shell-header-bg': '#161b22',
    '--graft-shell-sidebar-bg': '#111822',
    '--graft-shell-content-bg': '#0d1117',
    '--graft-shell-border-color': '#27313d',
    '--graft-card-bg': '#161b22',
    '--graft-card-bg-hover': '#1f2630',
    '--graft-card-border-color': '#27313d',
    '--graft-card-elevated-bg': '#1b222c',
