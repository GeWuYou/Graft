...
const (
	platformMaintenanceMenuOrder = 103
...
func registerMenu(registry *menu.Registry) error {
	...
	registry.Register(menu.Item{Code: "platform-maintenance", ParentCode: "domain.platform", Kind: menu.NodeKindGroup, TitleKey: "menu.platform.maintenance", Icon: "system-maintenance", Order: platformMaintenanceMenuOrder, Module: moduleID})
