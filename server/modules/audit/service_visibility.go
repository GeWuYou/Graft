...
func appendAuditEventCatalogSeeds() []auditEventCatalogSeed {
	return []auditEventCatalogSeed{
		...
		{Source: auditstore.AuditSourceDomainEvent, ActionKey: "ops.container.volume.remove", DisplayName: "ops.container.volume.remove", DescriptionKey: "audit.visibilityCatalog.container.volume.remove.description", Description: "Docker volume remove dangerous action event.", Category: "container"},
		{Source: auditstore.AuditSourceDomainEvent, ActionKey: "ops.container.volume.remove.batch", DisplayName: "ops.container.volume.remove.batch", DescriptionKey: "audit.visibilityCatalog.container.volume.remove.batch.description", Description: "Docker volume batch-remove dangerous action event.", Category: "container"},
