...
func adminOnlySystemPermissions() []string {
	return []string{
		...
		"notification.view", "notification.read", "notification.manage", "platform-backup.read", "platform-backup.create", "platform-update.read", "platform-update.check", "platform-update.manage",
