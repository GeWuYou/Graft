...
func TestGitHubReleaseProviderRequiresVerifiedRunnerIdentity(t *testing.T) {
	manifest := []byte(`{"version":"1.2.3","channel":"stable","images":{"server":{"image":"ghcr.io/gewuyou/graft-server","digest":"sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","reference":"ghcr.io/gewuyou/graft-server@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"},"web":{"image":"ghcr.io/gewuyou/graft-web","digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","reference":"ghcr.io/gewuyou/graft-web@sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"}},"runners":{"compose":{"image":"ghcr.io/gewuyou/graft-compose-runner","digest":"sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc","reference":"ghcr.io/gewuyou/graft-compose-runner@sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"}}}`)
	...
	if len(releases) != 1 || releases[0].RunnerRef != "ghcr.io/gewuyou/graft-compose-runner@sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc" {
