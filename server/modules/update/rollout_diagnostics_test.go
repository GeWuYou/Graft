...
func TestRolloutPreflightFailureCodesAreStable(t *testing.T) {
	tests := []struct {
		...
		{err: errRolloutImageTagUnconfigured, want: rolloutFailureImageTagUnconfigured},
		{err: errRolloutImageTagInvalid, want: rolloutFailureImageTagInvalid},
		{err: errRolloutCandidateConfirmation, want: rolloutFailureCandidateConfirmationRequired},
		{err: errRolloutNoEligibleRelease, want: rolloutFailureNoEligibleRelease},
