...
type Repository interface {
	...
	// CancelUntrackedRunningStage 以 CAS 结算已经收到取消请求、但当前 Runtime 没有本地 worker 跟踪的普通 running Stage。
	CancelUntrackedRunningStage(ctx context.Context, taskID uint64, stageID uint64, finishedAt time.Time, durationMS *int64) error
