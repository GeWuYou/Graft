...
func TestEphemeralAgentPKIFixtureSignsAndReconcilesExactCSR(t *testing.T) {
	...
	request := moduleapi.AgentCertificateIssuanceRequest{IdentityID: "identity-7", TargetID: 7, AgentID: "agent-7", Generation: 3, IssuanceKey: "issuance-7", SPIFFEURI: "spiffe://graft/runtime-target/7/runtime-agent/agent-7", CSRDER: csrDER}
