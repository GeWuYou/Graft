...
func setDefaults(reader *viper.Viper) {
	...
	reader.SetDefault("httpx.agent_bootstrap_tls.enabled", false)
	reader.SetDefault("httpx.agent_bootstrap_tls.addr", "")
	reader.SetDefault("httpx.agent_bootstrap_tls.certificate_file", "")
	reader.SetDefault("httpx.agent_bootstrap_tls.key_file", "")
	...
	reader.SetDefault("mcp.session_timeout", defaultMCPSessionTimeout)
	reader.SetDefault("mcp.request_timeout", defaultMCPRequestTimeout)
	reader.SetDefault("mcp.max_request_bytes", defaultMCPMaxRequestBytes)
	reader.SetDefault("mcp.max_sessions", defaultMCPMaxSessions)
	...
	reader.SetDefault("enrollment.pepper_file", "")
