...
func ContainerRegistry() []Entry {
	return []Entry{
		...
		{ID: "container.permission.volume-remove", Name: "VOLUME_REMOVE", Kind: KindPermissionCode, Owner: "server/modules/container/contract", Lifecycle: LifecycleActive, Visibility: VisibilityWeb, Value: containercontract.ContainerVolumeRemovePermission},
		{ID: "container.permission.network-create", Name: "NETWORK_CREATE", Kind: KindPermissionCode, Owner: "server/modules/container/contract", Lifecycle: LifecycleActive, Visibility: VisibilityWeb, Value: containercontract.DockerNetworkCreatePermission},
		{ID: "container.permission.network-remove", Name: "NETWORK_REMOVE", Kind: KindPermissionCode, Owner: "server/modules/container/contract", Lifecycle: LifecycleActive, Visibility: VisibilityWeb, Value: containercontract.DockerNetworkRemovePermission},
