...
const (
	DockerVolumeListUsageAbnormal GetDockerVolumesParamsUsage = "abnormal"
...
func (e GetDockerVolumesParamsUsage) Valid() bool {
	switch e {
	case DockerVolumeListUsageAbnormal:
		return true
...
const (
	DockerVolumeListSortBySizeBytes GetDockerVolumesParamsSortBy = "size_bytes"
)
...
func (e GetDockerVolumesParamsSortBy) Valid() bool {
	switch e {
	case DockerVolumeListSortBySizeBytes:
		return true
	default:
		return false
	}
...
const (
	DockerVolumeListSortOrderAsc  GetDockerVolumesParamsSortOrder = "asc"
	DockerVolumeListSortOrderDesc GetDockerVolumesParamsSortOrder = "desc"
)
...
func (e GetDockerVolumesParamsSortOrder) Valid() bool {
	switch e {
	case DockerVolumeListSortOrderAsc:
		return true
	case DockerVolumeListSortOrderDesc:
		return true
	default:
		return false
	}
...
type GetDockerVolumesParams struct {
	...
	SizeMinBytes *int64 `form:"size_min_bytes,omitempty" json:"size_min_bytes,omitempty"`

	// SizeMaxBytes Optional inclusive upper bound for known Docker volume usage in bytes.
	SizeMaxBytes *int64 `form:"size_max_bytes,omitempty" json:"size_max_bytes,omitempty"`
