...
import (
	...
	"graft/server/plugins/rbac/ent/migrate"
...
type (
	hooks struct {
		Permission, Role, RolePermission, UserRole []ent.Hook
	}
	inters struct {
		Permission, Role, RolePermission, UserRole []ent.Interceptor
	}
)
