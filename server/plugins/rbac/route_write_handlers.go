...
func handleUpdateRoleStatusRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	...
	role, err := writer.SetRoleStatus(ginCtx.Request.Context(), rbacstore.SetRoleStatusInput{ID: roleID, Status: status})
	if err != nil {
...
func handleDeleteRoleRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	...
	if err := writer.SoftDeleteRole(ginCtx.Request.Context(), rbacstore.SoftDeleteRoleInput{ID: roleID}); err != nil {
		writeRBACManagementError(ginCtx, ctx.I18n, ctx.Logger, pluginName, err, "id")
		return
	}
...
func handleReplaceRolePermissionsRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
...
//nolint:dupl // The generated request binders and write-service calls must stay explicit per operation.
func handleAddRolePermissionsRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	handleUserScopedStableIDsRoute(ginCtx, ctx, pluginName, "permission_ids",
		func(ginCtx *gin.Context, targetID uint64) ([]uint64, error) {
...
//nolint:dupl // The generated request binders and write-service calls must stay explicit per operation.
func handleRemoveRolePermissionsRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	handleUserScopedStableIDsRoute(ginCtx, ctx, pluginName, "permission_ids",
		func(ginCtx *gin.Context, targetID uint64) ([]uint64, error) {
...
//nolint:dupl // The generated request binders and write-service calls must stay explicit per operation.
func handleReplaceUserRolesRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
...
//nolint:dupl // The generated request binders and write-service calls must stay explicit per operation.
func handleAddUserRolesRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	handleUserScopedStableIDsRoute(ginCtx, ctx, pluginName, "role_ids",
		func(ginCtx *gin.Context, targetID uint64) ([]uint64, error) {
...
//nolint:dupl // The generated request binders and write-service calls must stay explicit per operation.
func handleRemoveUserRolesRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	handleUserScopedStableIDsRoute(ginCtx, ctx, pluginName, "role_ids",
		func(ginCtx *gin.Context, targetID uint64) ([]uint64, error) {
...
func handleBatchReplaceUserRolesRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
...
//nolint:dupl // Batch generated request binders intentionally stay parallel to preserve operation ownership.
func handleBatchAddUserRolesRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	handleBatchUserRoleRoute(ginCtx, ctx, pluginName,
		func(ginCtx *gin.Context) (batchStableIDSet, error) {
...
//nolint:dupl // Batch generated request binders intentionally stay parallel to preserve operation ownership.
func handleBatchRemoveUserRolesRoute(ginCtx *gin.Context, ctx *plugin.Context, pluginName string, writer writeManagementService) {
	handleBatchUserRoleRoute(ginCtx, ctx, pluginName,
		func(ginCtx *gin.Context) (batchStableIDSet, error) {
...
func handleBatchStableIDsRoute(
	...
	if err := config.write(ginCtx.Request.Context(), request.userIDs, request.roleIDs); err != nil {
		writeRBACManagementError(ginCtx, ctx.I18n, ctx.Logger, pluginName, err, config.invalidField)
		return
	}
	httpx.WriteSuccess[any](ginCtx, http.StatusOK, nil)
